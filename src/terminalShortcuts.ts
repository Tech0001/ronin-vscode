...
export function terminalShortcut(event: Pick<KeyboardEvent, 'key' | 'ctrlKey' | 'metaKey' | 'shiftKey' | 'altKey'> & { isComposing?: boolean }, mac: boolean): 'interrupt' | 'copy' | 'paste' | 'shiftEnter' | null {
